...
do -- Files
	...
	if not isfile("jitchjot/chatspam.jj") then
		writefile("jitchjot/chatspam.jj",
            [[BEACH BOAT ON TOP
JJOT NEW UPDATE 2058 ةشساشممشا
							...
							[1] = {
								content = {
									...
									},
									{
										...
										tooltip = "Spams chat, Custom options are located in the jitchjot/chatspam.bb",
									},
									{
										type = TOGGLE,
